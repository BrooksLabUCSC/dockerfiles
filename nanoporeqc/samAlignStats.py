...
#TODO: Allow paired end RNASeq input
...
def yieldBestHit(f):
    ...
    if not sortflag:
         print >>sys.stderr, "ERROR, cannot determine if your file is sorted, please run samtools sort -n"
         sys.exit(1)
    ...
    if line.startswith('@'):
         print >>sys.stderr, "ERROR, only header lines in input file"
         sys.exit(1)
